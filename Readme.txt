...
Documentation is exclusive created for FAXE.FAXE.java and FAXE.EmbeddedAnnotation.java as these ones represent the public accessible classes.
Intellij how to: https://www.jetbrains.com/help/idea/working-with-code-documentation.html#

Export of JAR library for further usage into out/artifacts/FAXE.FAXE-Feature_Annotation_eXtraction_Engine_jar
...
Remotes
git remote add github git@github.com:TobiasOnGitHub/FAXE.FAXE-Feature_Annotation_eXtraction_Engine.git
git remote add bb git@bitbucket.org:easelab/faxe.git

Remote Push URLs
git remote set-url --add --push origin git@github.com:TobiasOnGitHub/FAXE.FAXE-Feature_Annotation_eXtraction_Engine.git
