...
public class TanglingDegreeTest {
    ...
    public void testCalculateTD_File_FeeCategory() {
        ...
        File searchPath = new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\FeeCategory.java");
    ...
    public void testCalculateTD_File_SendCoinsFragment() {
        ...
        File searchPath = new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\SendCoinsFragment.java");
        Feature feature = new Feature("Fee");
        int td = 0;
        try {
            td = TanglingDegree.calculateTD(faxe.getKnownAssets(), searchPath, feature/*, true*/);
    ...
    public void testCalculateTD_Folder_Send() {
        ...
        File searchPath = new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send");
        Feature feature = new Feature("Fee");
        int td = 0;
        try {
            td = TanglingDegree.calculateTD(faxe.getKnownAssets(), searchPath, feature/*, true*/);
...
//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\FeeCategory.java"), feature, true), 3);
//            // Feature tangled: [Economic, Priority, Normal]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\SweepWalletFragment.java"), feature, true), 7);
//            // Feature tangled: [Denomination, SetPIN, SweepPaperWallet, EmptyWallet, SendCoins, BitcoinBalance, Normal]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\SendCoinsFragment.java"), feature, true), 21);
...
//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\SendCoinsViewModel.java"), feature, true), 5);
//            // Feature tangled: [AddressBook, SendCoins, ExchangeRates, BitcoinBalance, Normal]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\SendCoinsActivity.java"), feature, true), 2);
//            // Feature tangled: [DonateCoins, SendCoins]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\RaiseFeeDialogFragment.java"), feature, true), 5);
//            // Feature tangled: [Denomination, BlockchainSync, BackupWallet, SetPIN, Priority]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\send\\MaintenanceDialogFragment.java"), feature, true), 3);
//            // Feature tangled: [Denomination, BackupWallet, SetPIN]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\WalletTransactionsFragment.java"), feature, true), 12);
...
//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\WalletBalanceFragment.java"), feature, true), 6);
//            // Feature tangled: [Denomination, BlockchainSync, DonateCoins, SendCoins, BitcoinBalance, ExchangeRates]

//            Assert.assertEquals(TanglingDegree.calculateTD(faxe.getKnownAssets(),new File("C:\\Users\\Tobias\\IdeaProjects\\FAXE-Feature_Annotation_eXtraction_Engine\\src\\test\\testdata\\bitcoin-wallet\\ui\\TransactionsAdapter.java"), feature, true), 7);
