...
public class Configuration {
    ...
    public static final String PREFS_KEY_BTC_PRECISION = "btc_precision";	//&line[Denomination]
    public static final String PREFS_KEY_OWN_NAME = "own_name";
    public static final String PREFS_KEY_SEND_COINS_AUTOCLOSE = "send_coins_autoclose";	//&line[AutoCloseSendDialog]
    public static final String PREFS_KEY_CONNECTIVITY_NOTIFICATION = "connectivity_notification";	//&line[ConnectivityIndicator]
    public static final String PREFS_KEY_EXCHANGE_CURRENCY = "exchange_currency";	//&line[ExchangeRates]
    //&begin[TrustedPeer]
    public static final String PREFS_KEY_TRUSTED_PEER = "trusted_peer";
    public static final String PREFS_KEY_TRUSTED_PEER_ONLY = "trusted_peer_only";
    //&end[TrustedPeer]
    public static final String PREFS_KEY_BLOCK_EXPLORER = "block_explorer";	//&line[BlockExplorer]
    public static final String PREFS_KEY_DATA_USAGE = "data_usage";	//&line[DataUsage]
    public static final String PREFS_KEY_REMIND_BALANCE = "remind_balance";	//&line[BalanceReminder]
    public static final String PREFS_KEY_DISCLAIMER = "disclaimer";	//&line[ShowDisclaimer]
    ...
    //&begin[BackupReminder]
    public static final String PREFS_KEY_REMIND_BACKUP = "remind_backup";
    private static final String PREFS_KEY_LAST_BACKUP = "last_backup";
    //&end[BackupReminder]
    private static final String PREFS_KEY_LAST_BLUETOOTH_ADDRESS = "last_bluetooth_address";	//&line[Bluetooth]
