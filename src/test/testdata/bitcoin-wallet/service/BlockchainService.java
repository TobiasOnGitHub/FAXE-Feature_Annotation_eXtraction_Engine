...
public class BlockchainService extends LifecycleService {
    ...
    private boolean resetBlockchainOnShutdown = false;	//&line[ResetBlockChain]
    ...
    private void notifyCoinsReceived(@Nullable final Address address, final Coin amount,
        ...
        if (!notificationAddresses.isEmpty()) {
            ...
            for (final Address notificationAddress : notificationAddresses) {
                if (text.length() > 0)
                    text.append(", ");
				//&begin[Codecs]
                final String addressStr = notificationAddress.toBase58();	//&line[base58]
				//&end[Codecs]
        ...
        if (address != null) {
			//&begin[Codecs]
            final String addressStr = address.toBase58();	//&line[base58]
			//&end[Codecs]
    ...
    private final PeerDataEventListener blockchainDownloadListener = new AbstractPeerDataEventListener() {
        ...
        private final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                broadcastBlockchainState();	//&line[BlockchainSync]
            }
        };
    };
    ...
    public void onCreate() {
		...
		addressBookDao = AppDatabase.getDatabase(application).addressBookDao();	//&line[AddressBook]
        ...
        impediments.observe(this, new Observer<Set<Impediment>>() {
            ...
            private void startup() {
                ...
                peerGroup.addPeerDiscovery(new PeerDiscovery() {
                    private final PeerDiscovery normalPeerDiscovery = MultiplexingDiscovery	//&line[SkipDiscovery]
            ...
            private void shutdown() {
                ...
                peerGroup.stopAsync();	//&line[BlockChainSync]
                peerGroup = null;
