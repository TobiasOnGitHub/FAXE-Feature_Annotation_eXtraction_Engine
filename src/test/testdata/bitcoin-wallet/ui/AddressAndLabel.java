...
public class AddressAndLabel implements Parcelable {
    ...
    public AddressAndLabel(final NetworkParameters addressParams, final String address, @Nullable final String label)
		...
		//&begin[Codecs]
        this(Address.fromBase58(addressParams, address), label);	//&line[base58]
		//&end[Codecs]
    }
    ...
    public String toString() {
        ...
        builder.append('[');
		//&begin[Codecs]
        builder.append(address.toBase58());	//&line[base58]
		//&end[Codecs]
        if (label != null) {
            builder.append(',');
    ...
    public void writeToParcel(final Parcel dest, final int flags) {
		//&begin[Codecs]
        dest.writeString(address.toBase58());	//&line[base58]
		//&end[Codecs]
    ...
    private AddressAndLabel(final Parcel in) {
		//&begin[Codecs]
        address = Address.fromBase58(Constants.NETWORK_PARAMETERS, in.readString());	//&line[base58]
		//&end[Codecs]
        label = in.readString();
    }
}
