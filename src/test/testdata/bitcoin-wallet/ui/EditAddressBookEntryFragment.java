...
public final class EditAddressBookEntryFragment extends DialogFragment {
    ...
    public static void edit(final FragmentManager fm, final String address) {
		//&begin[Codecs]
        edit(fm, Address.fromBase58(Constants.NETWORK_PARAMETERS, address), null);	//&line[base58]
		//&end[Codecs]
    }
    ...
    private static EditAddressBookEntryFragment instance(final Address address,
		...
		//&begin[Codecs]
        args.putString(KEY_ADDRESS, address.toBase58());	//&line[base58]
		//&end[Codecs]
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
		...
		//&begin[Codecs]
        final Address address = Address.fromBase58(Constants.NETWORK_PARAMETERS, args.getString(KEY_ADDRESS));	//&line[base58]
		//&end[Codecs]
		...
		//&begin[Codecs]
        final String label = addressBookDao.resolveLabel(address.toBase58());	//&line[base58]
		//&end[Codecs]
        ...
        final DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, final int which) {
                if (which == DialogInterface.BUTTON_POSITIVE) {
                    ...
                    if (!newLabel.isEmpty())
						//&begin[Codecs]
                        addressBookDao.insertOrUpdate(new AddressBookEntry(address.toBase58(), newLabel));	//&line[base58]
						//&end[Codecs]
                    else if (!isAdd)
						//&begin[Codecs]
                        addressBookDao.delete(address.toBase58());	//&line[base58]
						//&end[Codecs]
