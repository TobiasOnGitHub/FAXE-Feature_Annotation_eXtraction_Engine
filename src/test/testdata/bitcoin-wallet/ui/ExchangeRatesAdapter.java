...
public class ExchangeRatesAdapter extends ListAdapter<ExchangeRatesAdapter.ListItem, ExchangeRatesAdapter.ViewHolder> {
    //&begin[SetDefault]
    public static List<ListItem> buildListItems(final Cursor cursor, final Coin balance,	//&line[BitcoinBalance]
    ...
    public static class ListItem {
        ...
        public final Fiat balanceAsFiat;	//&line[BitcoinBalance]
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            walletView = (CurrencyTextView) itemView.findViewById(R.id.exchange_rate_row_balance);	//&line[BitcoinBalance]
