...
public final class ExchangeRatesFragment extends Fragment
    ...
    public static class ViewModel extends AndroidViewModel {
        ...
        private WalletBalanceLiveData balance;	//&line[BitcoinBalance]
    ...
    private void maybeSubmitList() {
        ...
        if (exchangeRates != null)
            adapter.submitList(ExchangeRatesAdapter.buildListItems(exchangeRates, viewModel.getBalance().getValue(),	//&line[BitcoinBalance]
