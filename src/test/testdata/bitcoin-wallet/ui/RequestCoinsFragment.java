...
public final class RequestCoinsFragment extends Fragment {
    ...
    //&end[QRCode]
    private CheckBox acceptBluetoothPaymentView;	//&line[Bluetooth]
    private TextView initiateRequestView;
    private CurrencyCalculatorLink amountCalculatorLink;	//&line[CurrencyCalculator]

    private static final int REQUEST_CODE_ENABLE_BLUETOOTH = 0;	//&line[Bluetooth]
    private static final String KEY_RECEIVE_ADDRESS = "receive_address";	//&line[SenderAddress]
    ...
    public void onAttach(final Context context) {
        ...
        this.bluetoothAdapter = BluetoothAdapter.getDefaultAdapter();	//&line[Bluetooth]
        this.nfcAdapter = NfcAdapter.getDefaultAdapter(activity);	//&line[NFC]
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        amountCalculatorLink = new CurrencyCalculatorLink(btcAmountView, localAmountView);	//&line[CurrencyCalculator]
    ...
    public void onResume() {
        ...
        amountCalculatorLink.setListener(new CurrencyAmountView.Listener() {
            ...
            public void focusChanged(final boolean hasFocus) {
                ...
                acceptBluetoothPaymentView.setNextFocusUpId(activeAmountViewId);	//&line[Bluetooth]
            }
        });
        //&end[CurrencyCalculator]
    ...
    private void restoreInstanceState(final Bundle savedInstanceState) {
        if (savedInstanceState.containsKey(KEY_RECEIVE_ADDRESS))
			//&begin[Codecs]
            viewModel.freshReceiveAddress.setValue(Address.fromBase58(Constants.NETWORK_PARAMETERS,	//&line[base58]
			//&end[Codecs]
    ...
    public void onPrepareOptionsMenu(final Menu menu) {
        ...
        menu.findItem(R.id.request_coins_options_copy).setEnabled(hasBitcoinUri);	//&line[CopyRequest]
    ...
    private void handleLocalApp() {
        final ComponentName component = new ComponentName(activity, SendCoinsActivity.class);	//&line[SendCoins]
