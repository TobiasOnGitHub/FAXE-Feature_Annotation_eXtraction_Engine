    ...
    public void onListItemClick(final ListView l, final View v, final int position, final long id) {
        activity.startActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(final ActionMode mode, final Menu menu) {
                ...
                menu.findItem(R.id.wallet_addresses_context_browse).setVisible(Constants.ENABLE_BROWSE);	//&line[BlockExplorer]
                return true;
            }
            ...
            public boolean onPrepareActionMode(final ActionMode mode, final Menu menu) {
				...
				//&begin[Codecs]
                final String address = key.toAddress(Constants.NETWORK_PARAMETERS).toBase58();	//&line[base58]
				//&end[Codecs]
            ...
            public boolean onActionItemClicked(final ActionMode mode, final MenuItem item) {
                ...
                case R.id.wallet_addresses_context_browse:
					//&begin[Codecs]
                    final String address = getAddress(position).toBase58();	//&line[base58]
					//&end[Codecs]
            ...
            private void handleShowQr(final Address address) {
                final String uri = BitcoinURI.convertToBitcoinURI(address, null, viewModel.ownName.getValue(), null);	//&line[OwnName]
            ...
            private void handleCopyToClipboard(final Address address) {
				//&begin[Codecs]
                clipboardManager.setPrimaryClip(ClipData.newPlainText("Bitcoin address", address.toBase58()));	//&line[base58]
				//&end[Codecs]
