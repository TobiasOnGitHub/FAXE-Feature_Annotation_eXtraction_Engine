...
public class WalletAddressesViewModel extends AndroidViewModel {
    ...
    public final IssuedReceiveKeysLiveData issuedReceiveKeys;	//&line[IssueReporter]
    ...
    public WalletAddressesViewModel(final Application application) {
        ...
        this.issuedReceiveKeys = new IssuedReceiveKeysLiveData(this.application);	//&line[IssueReporter]
