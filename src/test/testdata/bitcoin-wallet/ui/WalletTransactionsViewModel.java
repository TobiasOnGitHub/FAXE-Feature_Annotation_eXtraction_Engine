...
public class WalletTransactionsViewModel extends AndroidViewModel {
    ...
    private final LiveData<List<AddressBookEntry>> addressBook;	//&line[AddressBook]
    ...
    public static class TransactionsLiveData extends AbstractWalletLiveData<Set<Transaction>> {
        ...
        private void addWalletListener(final Wallet wallet) {
            wallet.addCoinsReceivedEventListener(Threading.SAME_THREAD, walletListener);	//&line[ViewReceived]
            wallet.addCoinsSentEventListener(Threading.SAME_THREAD, walletListener);	//&line[ViewSent]
        ...
        private void removeWalletListener(final Wallet wallet) {
            ...
            wallet.removeCoinsSentEventListener(walletListener);	//&line[ViewSent]
            wallet.removeCoinsReceivedEventListener(walletListener);	//&line[ViewReceived]
        }
