...
public class WalletViewModel extends AndroidViewModel implements OnFirstPreDraw.Callback {
    ...
    private boolean doAnimation, globalLayoutFinished, balanceLoadingFinished, addressLoadingFinished,	//&line[BitcoinBalance]
    ...
    private void maybeToggleState() {
        if (enterAnimation.getValue() == null) {
            ...
            if (balanceLoadingFinished && addressLoadingFinished && transactionsLoadingFinished)	//&line[BitcoinBalance]
