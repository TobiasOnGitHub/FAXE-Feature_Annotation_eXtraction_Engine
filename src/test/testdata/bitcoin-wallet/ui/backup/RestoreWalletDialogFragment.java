...
public class RestoreWalletDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        passwordView = (EditText) view.findViewById(R.id.import_keys_from_storage_password);	//&line[SetPIN]
        ...
        builder.setPositiveButton(R.string.import_keys_dialog_button_import, new OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, final int which) {
                ...
                if (WalletUtils.BACKUP_FILE_FILTER.accept(file))	//&line[BackupWallet]
                    restoreWalletFromProtobuf(file);
                else if (WalletUtils.KEYS_FILE_FILTER.accept(file))
					//&begin[Codecs]
                    restorePrivateKeysFromBase58(file);	//&line[base58]
					//&end[Codecs]
                //&begin[SetPIN]
        ...
        fileView.setAdapter(new FileAdapter(activity) {
            ...
            public View getDropDownView(final int position, View row, final ViewGroup parent) {
                ...
                final boolean isExternal = Constants.Files.EXTERNAL_WALLET_BACKUP_DIR.equals(file.getParentFile());	//&line[BackupWallet]
    ...
    private void restoreWalletFromEncrypted(final File file, final String password) {	//&line[SetPIN]
        try {
            ...
            restoreWallet(WalletUtils.restoreWalletFromProtobufOrBase58(is, Constants.NETWORK_PARAMETERS));	//&line[base58]
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            ...
            dialog.setNeutralButton(R.string.button_ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int id) {
                    BlockchainService.resetBlockchain(getContext());	//&line[ResetBlockChain]
                    activity.finish();
                }
            });
