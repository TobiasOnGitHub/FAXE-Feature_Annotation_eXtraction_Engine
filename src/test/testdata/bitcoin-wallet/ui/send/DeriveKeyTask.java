...
public abstract class DeriveKeyTask {
    ...
    public final void deriveKey(final Wallet wallet, final String password) {	//&line[SetPIN]
            ...
            public void run() {
                ...
                if (keyCrypter instanceof KeyCrypterScrypt) {
                    ...
                    if (scryptIterations != scryptIterationsTarget) {
                        ...
                        final KeyParameter newKey = newKeyCrypter.deriveKey(password);	//&line[SetPIN]
