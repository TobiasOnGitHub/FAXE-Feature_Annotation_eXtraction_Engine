...
public class MaintenanceDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final MonetaryFormat format = application.getConfiguration().getFormat();	//&line[Denomination]
        messageView.setText(getString(R.string.maintenance_dialog_message, format.format(value), format.format(fee)));	//&line[Fee]
    ...
    private final TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(final CharSequence s, final int start, final int before, final int count) {
            badPasswordView.setVisibility(View.INVISIBLE);	//&line[SetPIN]
            updateView();
        }
