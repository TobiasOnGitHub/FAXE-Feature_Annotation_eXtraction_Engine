...
public class SweepWalletFragment extends Fragment {
    ...
    //&end[SetPIN]
    private TextView balanceView;	//&line[BitcoinBalance]
    ...
    public static class ViewModel extends AndroidViewModel {
        ...
        private DynamicFeeLiveData dynamicFees;	//&line[Fee]
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        balanceView = (TextView) view.findViewById(R.id.sweep_wallet_fragment_balance);	//&line[BitcoinBalance]
        ...
        viewGo = (Button) view.findViewById(R.id.send_coins_go);	//&line[SendCoins]
        ...
        viewCancel = (Button) view.findViewById(R.id.send_coins_cancel);	//&line[SendCoins]
    ...
    private void handleReload() {
        ...
        requestWalletBalance();	//&line[BitcoinBalance]
    }
    ...
    private void updateView() {
        final Map<FeeCategory, Coin> fees = viewModel.getDynamicFees().getValue();	//&line[Fee]
        ...
        if (viewModel.state == State.DECODE_KEY) {
            ...
            viewGo.setEnabled(viewModel.walletToSweep != null
                    //&begin[BitcoinBalance]
                    && viewModel.walletToSweep.getBalance(BalanceType.ESTIMATED).signum() > 0 && fees != null);	//&line[Fee]
                    //&end[BitcoinBalance]
        //&begin[SendCoins]
    ...
    private void handleSweep() {
        ...
        final SendRequest sendRequest = SendRequest.emptyWallet(application.getWallet().freshReceiveAddress());	//&line[EmptyWallet]
        sendRequest.feePerKb = fees.get(FeeCategory.NORMAL);	// &line[Normal]
        //&end[Fee]
        ...
        new SendCoinsOfflineTask(viewModel.walletToSweep, backgroundHandler) {
            ...
            protected void onFailure(final Exception exception) {
                ...
                final DialogBuilder dialog = DialogBuilder.warn(activity, R.string.send_coins_error_msg);	//&line[SendCoins]
