...
public class WalletApplication extends Application {
        ...
        getWalletExecutor.execute(new Runnable() {
            ...
            private void loadWalletFromProtobuf() {
                ...
                if (walletFile.exists()) {
                    ...
                    WalletUtils.autoBackupWallet(WalletApplication.this, wallet); // ...and backup asap	//&line[BackupWallet]
                    watch.stop();
                    log.info("fresh wallet created, took {}", watch);

                    config.armBackupReminder();	//&line[BackupReminder]
                }
            }
    ...
    public void replaceWallet(final Wallet newWallet) {
        newWallet.cleanup();
        BlockchainService.resetBlockchain(this);	//&line[ResetBlockChain]
        ...
        WalletUtils.autoBackupWallet(this, newWallet);	//&line[BackupWallet]
    ...
    private void cleanupFiles() {
        for (final String filename : fileList()) {
            //&begin[BackupWallet]
			//&begin[Codecs]
            if (filename.startsWith(Constants.Files.WALLET_KEY_BACKUP_BASE58)	//&line[base58]
			//&end[Codecs]
    ...
    public void processDirectTransaction(final Transaction tx) throws VerificationException {
        ...
        if (wallet.isTransactionRelevant(tx)) {
            ...
            BlockchainService.broadcastTransaction(this, tx);	//&line[BlockchainSync]
        }
    }
